...
const Index = () => {
  ...
  return (
    <div className="main-content">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Buğra Tunçer's Website</title>
        ...
        <div className="flex-d-row items-center initial-header content-center">
          <div className="flex-100 flex-md-50 initial-header-text-container">
            <h3 className="initial-header-text">
              Hi, I'm{" "}
              <span className="initial-header-text-name">Buğra Tunçer</span>{" "}
              <br />
      ...
      >
        ...
        <div className="flex-d-row flex-center">
          ...
          <div className="flex-100 flex-md-50">
            <Slide right>
              <p className="info">
                I'm a software developer the graduated from Çukurova University.Through
